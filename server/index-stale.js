...
//   const informConsumers = (roomName, producerSocketId, producerId) => {
//     console.log(
...
//   socket.on("transport-connect", ({ kind, dtlsParameters }) => {
